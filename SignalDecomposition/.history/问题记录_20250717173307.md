...
然后，我尝试了你上次修改之后的代码，在示波器上，A和A'的现象是这样的：以A为示波器触发源(A是信号源产生的信号)，A'是DDS模块ad9833产生的信号，漂移现象还是存在，才开始，漂移非常剧烈，而且伴随着剧烈的相位跳变，一会向左，一会向右，经过漫长的一段时间，信号住进稳定在一个平衡位置附近，在这个平衡位置附近小范围，小幅度颤动，但是这个平衡状态

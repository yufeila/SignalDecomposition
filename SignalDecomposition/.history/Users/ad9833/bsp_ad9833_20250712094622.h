...
#define AD9833_2_FSYNC_HIGH()   HAL_GPIO_WritePin(AD9833_2_FSYNC_PORT, AD9833_FSYNC_PIN, GPIO_PIN_SET)
#define AD9833_2_FSYNC_LOW()    HAL_GPIO_WritePin(AD9833_2_FSYNC_PORT, AD9833_FSYNC_PIN, GPIO_PIN_RESET)

#define AD9833_2_SCLK_HIGH()    HAL_GPIO_WritePin(AD9833_2_SCLK_PORT, AD9833_SCLK_PIN, GPIO_PIN_SET)
#define AD9833_2_SCLK_LOW()     HAL_GPIO_WritePin(AD9833_2_SCLK_PORT, AD9833_SCLK_PIN, GPIO_PIN_RESET)

#define AD9833_2_SDATA_HIGH()   HAL_GPIO_WritePin(AD9833_2_SDATA_PORT, AD9833_SDATA_PIN, GPIO_PIN_SET)
#define AD9833_2_SDATA_LOW()    HAL_GPIO_WritePin(AD9833_2_SDATA_PORT, AD9833_SDATA_PIN, GPIO_PIN_RESET)

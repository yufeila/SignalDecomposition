...
void Calibration_Frequency(void)
{
    ...
    // 8. 调整DDS频率
    AD9833_1_Config(freq_A, AD9833_OUT_SINUS);
    AD9833_2_Config(freq_B, AD9833_OUT_SINUS);

    // 9. 调整DDS相位
    AD9833_1_Config(freq_Apr, AD9833_OUT_SINUS);
    AD9833_2_Config(freq_Bpr, AD9833_OUT_SINUS);
}

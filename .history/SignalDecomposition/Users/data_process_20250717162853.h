 ...
 * @LastEditTime: 2025-07-17 15:25:06
...
#define MAVG          15                 /* 用 15 周期平均 */
#define KP            0.015f             /* PI 比例系数（降低以提高稳定性） */
#define KI            0.002f             /* PI 积分系数（降低以减少振荡） */
#define TOL_HZ        0.2f               /* 判断锁定阈值（更严格） */

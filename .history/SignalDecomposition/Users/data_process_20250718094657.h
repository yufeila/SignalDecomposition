 ...
 * @LastEditTime: 2025-07-18 09:46:57
...
/* FLL (锁频环) 控制器设计参数 */
#define FLL_BANDWIDTH_HZ        8.0f    /* 环路带宽(Hz): 降到8Hz，让系统更平缓，减少相位跳变 */
#define FLL_DAMPING_RATIO       0.9f    /* 阻尼比: 保持0.9以抑制过冲 */
#define FLL_MAX_STEP_HZ         5.0f    /* 单次最大调节步进(Hz): 从10Hz降到5Hz，让每次调节更平滑 */
#define FLL_DEAD_ZONE_HZ        2.0f    /* 死区(Hz): 保持不变 */

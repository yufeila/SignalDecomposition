...
void DDS_Output(Signal_t *sig)
{
    AD9833_1_Init();
    AD9833_2_Init();

    AD9833_1_Set_Frequency(sig->freq);
    AD9833_2_Set_Frequency(sig->freq);

    AD9833_1_Set_Amplitude(sig->amp);
    AD9833_2_Set_Amplitude(sig->amp);
}
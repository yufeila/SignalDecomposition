...
void Signal_Info_Display(Signal_t *sig1, Signal_t *sig2)
{
    ...
    // 显示信号2的频率和类型
    LCD_ShowString(10, 30, 200, 16, 16, (uint8_t*)"Signal 2:");
    LCD_ShowString(10, 90, 200, 16, 16, (uint8_t*)"Frequency: %.2f Hz", sig2->freq);
    LCD_ShowString(10, 110, 200, 16, 16, (uint8_t*)"Type: %d", sig2->wave_form);
}

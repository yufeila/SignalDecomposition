...
void Calibration_Frequency(void)
{
    ...
    uint16_t zc_count_A = find_zero_crossings(buf_A, CALIBRATION_BUF_SIZE, zcBuf, MAX_ZC);
    uint16_t zc_count_Apr = find_zero_crossings(buf_Apr, CALIBRATION_BUF_SIZE, zcBuf, MAX_ZC);
    uint16_t zc_count_B = find_zero_crossings(buf_B, CALIBRATION_BUF_SIZE, zcBuf, MAX_ZC);
    uint16_t zc_count_Bpr = find_zero_crossings(buf_Bpr, CALIBRATION_BUF_SIZE, zcBuf, MAX_ZC);

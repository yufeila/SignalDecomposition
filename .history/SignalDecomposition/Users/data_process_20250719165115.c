...
uint16_t phase_A_Sinus[TUNNING_SIZE_A]={0,0,0,0,0,0,0,0};
uint16_t phase_B_Sinus[TUNNING_SIZE_B]={0,0,0,0,0,0,0,0};
uint16_t phase_A_Triangle[TUNNING_SIZE_A]={0,0,0,0,0,0,0,0};
uint16_t phase_B_Triangle[TUNNING_SIZE_B]={0,0,0,0,0,0,0,0};

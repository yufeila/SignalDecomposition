...
uint16_t phase_A_Sinus[TUNNING_SIZE_A][TUNNING_SIZE_B]=
{
    /* fA' = 20kHz */
    {0,0,0,0,0,0,0,0},
    /* fA' = 30kHz */
...
static void phase_tunning(Signal_t *sig1, Signal_t *sig2, uint16_t *dphase)
{

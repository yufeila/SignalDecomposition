...
void Calibration_Frequency(void)
{
    ...
    uint16_t zc_count_A = zero_cross_detection(buf2_A, CALIBRATION_BUF_SIZE, &zc_idx_Apr);
    uint16_t zc_count_B = zero_cross_detection(buf1_B, CALIBRATION_BUF_SIZE, &zc_idx_B);
    uint16_t zc_count_B = zero_cross_detection(buf2_B, CALIBRATION_BUF_SIZE, &zc_idx_Bpr);
